...
export function setAllTimeline() {
  // Fade out the entire landing section content as user scrolls down
  const landingFadeTimeline = gsap.timeline({
    scrollTrigger: {
      trigger: ".landing-section",
      start: "top top",       // starts when top of section hits top of viewport
      end: "bottom top",      // ends when bottom of section scrolls past top
  ...
  landingFadeTimeline
    ...
    .to(".landing-bg-text", { opacity: 0, duration: 0.3 }, 0);
